...
export const Device: FC<IDeviceProps> = ({ url, className }) => {
  ...
  return (
    <div className={'i-doc-device'} data-device-type='iOS' data-mode={mode}>
      <iframe title='dumi-previewer' id="preview-device" src={url} key={renderKey} />
      <div className='i-doc-device-action'>
        <button
